...
if ( !in_array( $_FILES['image']['type'], $accepted_image_types ) ) {
    ...
    $error_message .= "<p class='info_message'>The image type you are trying to upload isn't acceptable <br /><br />Image must be of type ( jpg ) or ( gif ) or ( png )</p>";
...
//make_image_copy($_FILES['image']['tmp_name'], $_FILES['image']['type'], $original_width, $original_height, $desired_img_width, $new_height, "../uploads/projects/$new_image_name" );
make_image_copy($_FILES['image']['tmp_name'], $_FILES['image']['type'], $original_width, $original_height, $desired_img_width,  "../uploads/projects/$new_image_name" );
...
//make_image_copy($_FILES['image']['tmp_name'], $_FILES['image']['type'], $original_width, $original_height, $desired_medium_width, $new_height, "../uploads/projects/medium/$new_image_name" );
make_image_copy($_FILES['image']['tmp_name'], $_FILES['image']['type'], $original_width, $original_height, $desired_medium_width, "../uploads/projects/medium/$new_image_name" );

//make_image_copy($_FILES['image']['tmp_name'], $_FILES['image']['type'], $original_width, $original_height, $desired_thumb_width, $new_height, "../uploads/projects/thumb/$new_image_name" );
make_image_copy($_FILES['image']['tmp_name'], $_FILES['image']['type'], $original_width, $original_height, $desired_thumb_width, "../uploads/projects/thumb/$new_image_name" );
