...
if ( !in_array( $_FILES['image']['type'], $accepted_image_types ) ) {
    $error_message .= "<p class='info_message'>The type of the image isn't acceptable<br /><br />It must be  ( jpg ) or ( gif ) or ( png )</p>";
}
...
make_image_copy($_FILES['image']['tmp_name'], $_FILES['image']['type'], $original_width, $original_height, $desired_img_width, "../uploads/slider/$new_image_name" );
...
make_image_copy($_FILES['image']['tmp_name'], $_FILES['image']['type'], $original_width, $original_height, $desired_medium_width, "../uploads/slider/medium/$new_image_name" );
make_image_copy($_FILES['image']['tmp_name'], $_FILES['image']['type'], $original_width, $original_height, $desired_thumb_width,  "../uploads/slider/thumb/$new_image_name" );
